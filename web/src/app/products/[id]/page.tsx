        ...
        <div className="product-detail__inner">
          ...
          <div className="product-detail__info">
            ...
            <div className="product-detail__cta">
              <a className="btn btn--whatsapp" href={whatsappLink(product.name, product.sku, cfg.whatsappNumber, cfg.footer.brand.replace('\n', ' '))} target="_blank" rel="noopener">
              ...
              <a className="btn btn--secondary" href={whatsappLink(product.name, product.sku, cfg.whatsappNumber, cfg.footer.brand.replace('\n', ' '))} target="_blank" rel="noopener">Request private viewing</a>
            </div>
        ...
        <div className="story-strip__inner">
          <div>
            ...
            <div style={{ marginTop: '2rem' }}>
              <a className="btn btn--outline" href={whatsappLink(product.name, product.sku, cfg.whatsappNumber, cfg.footer.brand.replace('\n', ' '))} target="_blank" rel="noopener">Enquire on WhatsApp <span className="btn__arrow"></span></a>
            </div>
          </div>
